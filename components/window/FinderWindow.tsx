  ...
  return (
    <section>
      ...
      <div className="fm-chip-row" aria-label="Highlights">
        <span className="fm-chip">Product Design</span>
        <span className="fm-chip">Creative Dev</span>
        <span className="fm-chip">3D + Web</span>
        <span className="fm-chip">Frontend Systems</span>
      </div>
    </section>
  );
}